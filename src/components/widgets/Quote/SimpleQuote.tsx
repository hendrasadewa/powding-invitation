...
export default function SimpleQuote({ content, source }: Props) {
  return (
    <div className="w-full flex items-center justify-center relative h-64">
      ...
      <div className="flex flex-col gap-2 items-center justify-center max-w-3xl z-10">
        <blockquote className="text-xl text-center text-white">
          {content}
        </blockquote>
        <p className="text-lg text-center text-white">({source})</p>
      </div>
    </div>
  );
}
